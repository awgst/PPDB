                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="proedit.php" method="POST">
                                        <input type="hidden" name="passlama" value="<?=$pass?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Nama" required="required" value="<?=$nama?>">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Username" required="required" name="uname" value="<?=$data['uname']?>" readonly='true'>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <?php
                                                if (isset($_GET['pesan'])) {
                                                    if ($_GET['pesan']=="gagal") {
                                                        ...
                                                        echo "<p>Password telah diganti</p>";
                                                    }
                                                }
                                            ?>
