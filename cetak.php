    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="view-cetak.php">
                        <h3>Selamat datang di PPDB Online SMP N 1 Gabus</h3>
                        <h4>Masukkan NISN</h4>
                        <div class="form-row">
                        ...
                        <button class="btn btn--radius-2 btn--red" type="submit" id="submit">Proses</button>
                    </form>
                </div>
            </div>
        </div>
